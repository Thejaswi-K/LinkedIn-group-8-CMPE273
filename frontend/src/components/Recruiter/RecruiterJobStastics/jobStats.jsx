    ...
    return (
      <div>
        ...
        <h1 data-test-post-page-title="" className="jobs__main-title" style={{ marginLeft: "5rem", marginTop: "3rem" , marginBottom:"2rem"}}>
                <b><span style={{ fontSize: "130%", color: "#006097" }}>{this.state.jobData.length}</span> Applicant applied for the this Job</b>
            </h1>
          {allImgs.map((job, i) => (
            <div
              className="card"
            ...
            >
              ...
              <div className="modal fade" id="resumeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                aria-hidden="true">
